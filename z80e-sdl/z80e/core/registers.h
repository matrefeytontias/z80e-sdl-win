...
inline uint8_t _flag_undef_8(uint8_t a) {
	uint8_t _res = a;
	return __flag_5(_res & 0x20) | __flag_3(_res & 0x8);
}

inline uint16_t _flag_undef_16(uint16_t a) {
	uint16_t _res = a;
	return __flag_5(_res & 0x2000) | __flag_3(_res & 0x800);
}
